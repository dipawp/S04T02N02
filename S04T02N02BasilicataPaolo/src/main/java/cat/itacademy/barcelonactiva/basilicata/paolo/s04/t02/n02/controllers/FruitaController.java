package cat.itacademy.barcelonactiva.basilicata.paolo.s04.t02.n02.controllers;
...
import cat.itacademy.barcelonactiva.basilicata.paolo.s04.t02.n02.model.services.FruitaServiceImpl;
...
public class FruitaController {
	...
	public ResponseEntity<Fruita> updateFruita(@RequestBody Fruita fruita){
		...
		if(fruitaData.isPresent()) {
			...
			fruitaServiceImpl.addFruita(_fruita);
